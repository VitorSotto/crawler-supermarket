...
class CrawlerSuperTonin(Mercado):
    ...
    def Browsingsite(self):
        ...
        synchronous.get(*self.browser, url)
        sleep(5)
        # element = self.browser.find_element(By.CSS_SELECTOR,'a.popup-next-tip:nth-child(4)')
        element = synchronous.find_element(*self.browser, By.CSS_SELECTOR, 'a.popup-next-tip:nth-child(4)')
        # element.click()
        synchronous.click(*self.browser, element)
        sleep(2)
        # to_click = self.browser.find_element(By.CSS_SELECTOR,'.header-text > div:nth-child(2)')
        to_click = synchronous.find_child_element(*self.browser, By.CSS_SELECTOR, '.header-text > div:nth-child(2)')
        # to_click.click()
        synchronous.click(*self.browser, to_click)
        sleep(2)
        ...
        select_city = synchronous.find_element(*self.browser, By.CSS_SELECTOR, 'div[tooltip="Araraquara - Vl. Santana - LJ 11 - Superatacado"]')
        # select_city.click()
        synchronous.click(*self.browser, select_city)
        sleep(0.5)
